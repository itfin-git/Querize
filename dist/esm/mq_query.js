...
(function (MQQuery) {
    ...
    class Class {
        ...
        table(name) { return new MQQuery.Class(this).#_table('table', name, arguments); }
        inner(name) { return this.#_table('inner', name, arguments); }
        left(name) { return this.#_table('left', name, arguments); }
        right(name) { return this.#_table('right', name, arguments); }
        on(onevent, values) {
