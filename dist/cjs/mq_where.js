...
(function (MQWhere) {
    ...
    class Class {
        ...
        select(...fields) {
            this.owner.dml = mq_query_js_1.MQQuery._sql_select(this.owner, fields.flat(), this);
            return this.owner;
        ...
        delete() {
            this.owner.dml = mq_query_js_1.MQQuery._sql_delete(this.owner, this);
            return this.owner;
        }
        update(fields) {
            this.owner.dml = mq_query_js_1.MQQuery._sql_update(this.owner, fields, this);
            return this.owner;
        }
        execute() {
    ...
    MQWhere.Class = Class;
    ;
})(MQWhere || (exports.MQWhere = MQWhere = {}));
;
